<template>
  <div class="header" :class="[{ fixedToTop }, themeColor]">
    <div class="logo">
      ...
      <img src="../assets/images/logo.png" alt="" width="150" height="35" >
    </div>
    <ul class="navbar">
      ...
      <router-link exact to="/forum" v-slot="{ href, navigate, isActive }">
        <li class="navbar-item" :class="{ active: isActive }">
          <a :href="href" @click="navigate">讨论</a>
        </li>
      </router-link>

      <li class="navbar-item">
        <!-- <a href="https://job.bytedance.com/campus" target="_blank">校园招聘</a> -->
        <a href="#">校园招聘</a>  <!--a标签target属性 浏览器总在一个新打开、未命名的窗口中载入目标文档。 -->
      </li>
    </ul>|
    <div class="user">
